...
results_files = [
    'D:/123main/runs/exp (_init_)/results.csv',
    'D:/123main/runs/exp1 (other)/results.csv',
]
...
pr_csv_dict = {
    'YOLOv8s': r'D:\123main\runs\exp (PR  _init_)\PR_curve.csv',
    'YOLOv8s-DWC & Swin': r'D:\123main\runs\exp1 (PR other)\PR_curve.csv',
}

f1_csv_dict = {
    'YOLOv8s': r'D:\123main\runs\exp (F1 _init_)\F1_curve.csv',
    'YOLOv8s-DWC & Swin': r'D:\123main\runs\exp1 (F1 other)\F1_curve.csv',
}
