...
class space_to_depth(nn.Module):
    ...
    def forward(self, x):
        ...
        assert height % self.block_size == 0 and width % self.block_size == 0, "Input dimensions must be divisible by block_size"
        
        # Reshape and permute
        return x.view(batch_size, channels, height // self.block_size, self.block_size, width // self.block_size, self.block_size)\
            .permute(0, 1, 3, 2, 4, 5).contiguous()\
            .view(batch_size, channels * (self.block_size ** 2), height // self.block_size, width // self.block_size)
...
class VoVGSCSP(nn.Module):
    ...
    def __init__(self, cx, c2, n=1, shortcut=True, g=1, e=0.5):
        ...
        self.cv1 = Conv(c_, c_, 1, 1)  #修改
        self.cv2 = Conv(c_, c_, 1, 1)  #修改
...
class VoVGSCSPC(VoVGSCSP):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        ...
        self.gsb = GSBottleneck(c_, c_, 1, 1)  #修改
